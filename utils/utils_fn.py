...
def evaluate(df1, df2, savepath):
    ...
    df_results = pd.DataFrame(columns=["r", "ccc", "rmse"], index=common+["avg", "overall"])
    ...
    avg_r, avg_ccc, avg_rmse = avg_r/len(common), avg_ccc/len(common), avg_rmse/len(common)
    ...
    df_results.loc["overall", ["r", "ccc", "rmse"]] = overall_r, overall_ccc, overall_rmse
